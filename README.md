...
Lesson Maintainers communication is via the [team site](insert link here).
...
There are many ways to discuss and contribute to Library Carpentry lessons. Visit the lesson [discussion page](insert link here) to learn more. Also see [Contributing](insert link here).
...
To check and preview a lesson locally, see[insert link here].
